...
if (UNIX)
  ...
  if (OPTION_USE_WAYLAND)
    ...
    if (X11_FOUND)
      ...
      set (HAVE_XINPUT 1)
      if (NOT X11_Xi_FOUND)
        message(WARNING "Install development headers for libXi (e.g., libxi-dev)")
      endif()
      set (USE_XFT 1)
...
#######################################################################
if (X11_Xi_FOUND)
	option (OPTION_USE_XINPUT "use lib XInput" ON)
endif (X11_Xi_FOUND)

if (OPTION_USE_XINPUT)
  set (HAVE_XINPUT ${X11_Xi_FOUND})
  if (HAVE_XINPUT)
    include_directories (${X11_Xi_INCLUDE_PATH})
    list (APPEND FLTK_LDLIBS -lXi)
    set (FLTK_XINPUT_FOUND TRUE)
  else(HAVE_XINPUT)
    set (FLTK_XINPUT_FOUND FALSE)
  endif (HAVE_XINPUT)
else(OPTION_USE_XINPUT)
  set (FLTK_XINPUT_FOUND FALSE)
endif (OPTION_USE_XINPUT)
