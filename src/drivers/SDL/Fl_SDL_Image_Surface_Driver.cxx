...
Fl_SDL_Image_Surface_Driver::Fl_SDL_Image_Surface_Driver(int w, int h, int high_res, Fl_Offscreen off)
: Fl_Image_Surface_Driver(w, h, high_res, NULL)
{
  
}

Fl_SDL_Image_Surface_Driver::~Fl_SDL_Image_Surface_Driver()
{
