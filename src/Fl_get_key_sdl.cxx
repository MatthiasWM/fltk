...
//
// SDL keyboard state routines for the Fast Light Tool Kit (FLTK).
//
...
#include "drivers/SDL/Fl_SDL_System_Driver.H"
#include <FL/platform.H>

// Convert an FLTK (X) keysym to an SDL VK symbol:
// See also the inverse converter in Fl_sdl.cxx
