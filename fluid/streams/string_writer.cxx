...
/**
 ...
 is determined by `Fluid.project.i18n_type`.
...
int stream::write_strings(const Fl_String &filename) {
  ...
  switch (Fluid.project.i18n_type) {
    case Fd_I18n_Type::NONE : /* None, just put static text out */
      ...
      break;
    case Fd_I18n_Type::GNU : /* GNU gettext, put a .po file out */
      fprintf(fp, "# generated by Fast Light User Interface Designer (fluid) version %.4f\n",
              FL_VERSION);
      for (p = Fl_Type::first; p; p = p->next) {
        if (p->is_widget()) {
      ...
      break;
    case Fd_I18n_Type::POSIX : /* POSIX catgets, put a .msg file out */
      fprintf(fp, "$ generated by Fast Light User Interface Designer (fluid) version %.4f\n",
              FL_VERSION);
      fprintf(fp, "$set %s\n", Fluid.project.i18n_pos_set.c_str());
      fputs("$quote \"\n", fp);
