...
extern fluid::widget::CodeViewer *cv_source;
extern fluid::widget::CodeViewer *cv_header;
extern fluid::widget::TextViewer *cv_strings;
extern fluid::widget::TextViewer *cv_project;
