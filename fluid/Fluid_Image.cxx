...
size_t Fluid_Image::write_static_binary(fluid::stream::CodeWriter& f, const char* fmt) {
  size_t nData = 0;
...
/** Write the contents of the name() file as textual source code.
 \param fmt short name of file contents for error message
 \return 0 if the file could not be opened or read */
size_t Fluid_Image::write_static_text(fluid::stream::CodeWriter& f, const char* fmt) {
  size_t nData = 0;
  Fluid.project.enter_project_dir();
  FILE *in = fl_fopen(name(), "rb");
  Fluid.project.leave_project_dir();
...
void Fluid_Image::write_static_rgb(fluid::stream::CodeWriter& f, const char* idata_name) {
  // Write image data...
  f.write_c("\n");
 ...
 */
void Fluid_Image::write_static(fluid::stream::CodeWriter& f, int compressed) {
  if (!img) return;
...
void Fluid_Image::write_file_error(fluid::stream::CodeWriter& f, const char *fmt) {
...
void Fluid_Image::write_initializer(fluid::stream::CodeWriter& f, const char *type_name, const char *format, ...) {
...
void Fluid_Image::write_code(fluid::stream::CodeWriter& f, int bind, const char *var, int inactive) {
...
void Fluid_Image::write_inline(fluid::stream::CodeWriter& f, int inactive) {
  if (img)
